...
interface PropsType {
  setIsPrivateModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
  setIsOn: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function Private({ setIsPrivateModalOpen, setIsOn }: PropsType) {
      ...
      <S.PrivateModalWrapper onClick={handleModalContentClick}>
        <S.PrivateModalBox>
          ...
          <S.PrivateModalMessage>
            ...
            변경되지 않지만, 회원님을 팔로우하지 않는 사람을 태그할 수 없게 됩니다.
          </S.PrivateModalMessage>
        </S.PrivateModalBox>{" "}
        <S.PrivateFooter>
          <S.PrivateBtn
